...
const ProjectStatusModal = ({ id, overlayOpen, closeOverlay }) => {
  const [status, setStatus] = useState("WIP");
  const [projectStatusUpdate, isLoading] = useProjectStatusUpdateMutation();


  const submitStatus = async (e) => {
    e.preventDefault();
    try {
      const res = await projectStatusUpdate({ project_status: status, id }).unwrap();
      console.log(res);
      if (res.msg) {
